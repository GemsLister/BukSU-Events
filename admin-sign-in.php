...
<head>
    ...
    <link rel="stylesheet" href="../BukSU-Events/css-style/admin-sign-in.css">
</head>
<body>
    <!-- header section -->
    ...
    <main class="container-fluid d-flex h-100">
        <!-- sign-in form -->
        <form name="sign-in-form" action="admin-sign-in-validate.php" method="POST" class="d-flex login-form">
