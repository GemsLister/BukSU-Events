...
// Fetch user details
$stmtUser = $pdo->prepare("SELECT firstname, lastname, contact_no FROM users WHERE user_id = ? AND roles = 'student'");
$stmtUser->execute([$_SESSION['user_id']]);
$student_user = $stmtUser->fetch(PDO::FETCH_ASSOC);
...
// Fetch registered (attended) events for the logged-in student
$stmtRegistered = $pdo->prepare("
    SELECT e.*, a.attendance_date, a.attendance_status
    FROM attendees a
    JOIN events e ON a.event_id = e.event_id
    WHERE a.user_id = ? AND a.roles = 'student'
...
<div class="modal fade" id="editProfileModal" tabindex="-1" aria-labelledby="editProfileModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <form method="POST" action="student-dashboard.php" id="editProfileForm">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="mb-3">
            ...
            <input type="text" class="form-control" id="editFirstname" name="edit_firstname" value="<?php echo htmlspecialchars($student_user['firstname']); ?>" required>
          </div>
          <div class="mb-3">
            <label for="editLastname" class="form-label">Last Name</label>
            <input type="text" class="form-control" id="editLastname" name="edit_lastname" value="<?php echo htmlspecialchars($student_user['lastname']); ?>" required>
          </div>
          <div class="mb-3">
            <label for="editContact" class="form-label">Contact No</label>
            <input type="text" class="form-control" id="editContact" name="edit_contact_no" value="<?php echo isset($student_user['contact_no']) ? htmlspecialchars($student_user['contact_no']) : ''; ?>" required>
          </div>
          <div class="mb-3">
...
document.getElementById('editProfileForm').addEventListener('submit', function(e) {
    ...
    <aside class="sidebar">
        <figure class="sidebar-header mt-4">
            ...
            <figcaption>
                Welcome <?php echo htmlspecialchars($student_user['firstname']) . ' ' . htmlspecialchars($student_user['lastname']); ?>
            </figcaption>
        ...
        <nav class="nav flex-column">
            ...
            <a href="student-dashboard.php" class="nav-link active"><i class="fa-solid fa-check"></i>Registered Events</a>
            <a href="land-page.php" class="nav-link"><i class="fas fa-arrow-left"></i>Back to Home</a>
